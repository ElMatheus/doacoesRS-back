...
async function createGift(req, res) {
  try {
    ...
    const result = await pool.query('INSERT INTO gift (categoria, nome_produto, quantidade, local_entrega) VALUES ($1, $2, $3, $4) RETURNING *', [categoria, nome_produto, quantidade, local_entrega]);
    res.json({
